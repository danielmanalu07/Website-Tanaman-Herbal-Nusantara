...
(function () {
    ...
    localStorage.getItem('direction') == 'rtl' && document.getElementById("stylesheet").setAttribute('href', '/admin/html/full/assets/css/rtl/all.min.css');
        ...
        if (dirSwitch) {
            ...
            function resetDir() {
                if (dirSwitch.checked) {
                    document.getElementById("stylesheet").setAttribute('href', '/admin/html/full/assets/css/rtl/all.min.css');
