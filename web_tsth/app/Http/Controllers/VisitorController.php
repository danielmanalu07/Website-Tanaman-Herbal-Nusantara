...
{
    private $auth_service, $visitor_service, $visitor_category_service;

    public function __construct(AuthService $auth_service, VisitorService $visitor_service, VisitorCategoryService $visitor_category_service)
    {
    ...
    public function index()
    {
        try {
            ...
            // dd($visitors);
            return view('Admin.Visitor.index', compact('data', 'visitors', 'visitor_categories'));
        } catch (\Throwable $th) {
